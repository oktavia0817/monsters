...
$now = time;
$outtime = $otime + (3 * 60);
if(($login == 1 && $now >= $outtime) or $login == 0 or $inname == $name){$login = 0;}
if($login == 1){&error("現在お見合い所は$nameさんが使用中です。しばらくしてからご入室下さい。");}
$now = time;

&lock;
open(FH,">dat/time3.cgi");
print FH "1<>$inname<>$now";
close(FH);
&unlock;
...
if($Kimg[2] != 0){
print <<"EOF";
<TD rowspan="2" width="79" bgcolor="#ffffff" align="center">
<FORM ACTION="$cgiurl" METHOD="POST">
<INPUT type="submit" value="承諾する">
<INPUT type="hidden" name="mode" value="omiyes">
...
<TD rowspan="2" width="79" bgcolor="#ffffff" align="center">
<FORM ACTION="$cgiurl" METHOD="POST">
<INPUT type="submit" value="お断りする">
<INPUT type="hidden" name="mode" value="omino">
<INPUT type="hidden" name="name" value="$inname">
<INPUT type="hidden" name="password" value="$inpass">
</FORM>
EOF
...
<HR>
<FORM ACTION="$cgiurl" METHOD="POST">
<P>お見合いに出すモンスターの設定<BR>
<BR>
相手ユーザー名の選択</P>
<SELECT name=BBNAME>
<option value=non >設定解除
EOF
...
foreach $line1 (@lines) {
    ($Sname,$Spass,$Sip,$Sbye,$Splay,$Splay2,$Yplay3,$Skey,$Simg1,$Shai1,$Slev1,$Simg2,$Shai2,$Slev2,$Simg3,$Shai3,$Slev3,$Smoney,$Smes,$Sturn) = split(/<>/,$line1);
print "<option value=$Sname >$Sname\n";
}
print <<"EOF";
</SELECT>
<INPUT type="submit" value="相手ユーザー名決定">
<INPUT type="hidden" name="mode" value="omisen">
<INPUT type="hidden" name="name" value="$inname">
<INPUT type="hidden" name="password" value="$inpass">
</FORM>
<BR>
...
<TD rowspan="2" >
<FORM ACTION="$cgiurl" METHOD="POST">
<INPUT type="submit" value="LOGIN画面に移動させる">
<INPUT type="hidden" name="mode" value="seikou1">
<INPUT type="hidden" name="name" value="$inname">
<INPUT type="hidden" name="password" value="$inpass">
<INPUT type="hidden" name="MONEY1" value="$MONEY1">
</FORM>
</TD>
</TR>
<TR>
...
<FORM ACTION="$cgiurl" METHOD="POST">
<INPUT type="submit" value="LOGIN画面に移動させる">
<INPUT type="hidden" name="mode" value="seikou2">
<INPUT type="hidden" name="name" value="$inname">
<INPUT type="hidden" name="password" value="$inpass">
<INPUT type="hidden" name="MONEY2" value="$MONEY2">
</FORM>
</TD>
</TR>
<TR>
...
<FORM ACTION="$cgiurl" METHOD="POST">
<INPUT type="submit" value="LOGIN画面に移動させる">
<INPUT type="hidden" name="mode" value="fusei1">
<INPUT type="hidden" name="name" value="$inname">
<INPUT type="hidden" name="password" value="$inpass">
</FORM>
</TD>
...
<FORM ACTION="$cgiurl" METHOD="POST">
<INPUT type="submit" value="LOGIN画面に移動させる">
<INPUT type="hidden" name="mode" value="fusei2">
<INPUT type="hidden" name="name" value="$inname">
<INPUT type="hidden" name="password" value="$inpass">
</FORM>
</TD>
